...
const Navbar = () => {
  ...
  useEffect(() => {
    axios.get("https://fintrust-backend.onrender.com/auth/getUser", { withCredentials: true })
      .then(res => setUser(res?.data?.userdata))
      .catch(err => console.error("Failed to fetch user:", err));
  }, []);
    const handlelogout = async ()=>{
    await axios.post("https://fintrust-backend.onrender.com/auth/logout",{},{withCredentials:true});
    navigate("/login")
